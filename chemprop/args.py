...
Metric = Literal['auc', 'prc-auc', 'rmse', 'mae', 'mse',
                 'r2', 'accuracy', 'cross_entropy', 'binary_cross_entropy']
...
class CommonArgs(Tap):
    ...
    """Path to generated adjacency matrices to use in Atom attention block."""
    distance_path: str = None
    """Path to generated distance matrices to use in Atom attention block."""
    coulomb_path: str = None
    """Path to generated coulomb matrices to use in Atom attention block."""
...
class TrainArgs(CommonArgs):
    ...
    split_type: Literal['random', 'scaffold_balanced', 'predetermined',
                        'crossval', 'cv', 'cv-no-test', 'index_predetermined'] = 'random'
    ...
    separate_val_adjacency_path: str = None
    """Path to file with adjacency matrices for separate val set."""
    separate_test_adjacency_path: str = None
    """Path to file with adjacency matrices for separate test set."""
    separate_val_distance_path: str = None
    """Path to file with distance matrices for separate val set."""
    separate_test_distance_path: str = None
    """Path to file with distance matrices for separate test set."""
    separate_val_coulomb_path: str = None
    """Path to file with coulomb matrices for separate val set."""
    separate_test_coulomb_path: str = None
    """Path to file with coulomb matrices for separate test set."""
    ...
    bond_attention: bool = False
    """Self attention in message passing phase."""
    bond_fast_attention: bool = False
    """Fast attention in message passing phase."""
    ...
    """Whether to add adjacency feature matrix to the attention weight"""
    distance: bool = False
    """Whether to add distance matrix to the attention weight"""
    coulomb: bool = False
    """Whether to add coulomb matrix to the attention weight"""
